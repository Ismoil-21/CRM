...
// Mentor portaliga faqat Mentor kirishi mumkin
function applyMentorGuard() {
  ...
  window.showApp = function () {
    ...
    if (user.role !== 'Mentor') {
      ...
      if (errEl) { errEl.textContent = '🚫 Bu portal faqat Mentor uchun!'; errEl.style.display = 'block' }
...
.boot-error button {
  padding: .5rem 1.25rem; background: #10b981;
